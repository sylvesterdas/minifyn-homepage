...
export const Sidebar = () => {
  return (
    <div className="w-max max-sm:w-full max-sm:px-4 border-r border-default-100 flex flex-col">
      <div className="max-sm:hidden p-6 border-b border-default-100">
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="p-4">
          <div className="rounded-medium bg-gray-900 p-4">
          ...
          <div className="mt-8">
            <div className="text-tiny font-medium text-default-400 uppercase tracking-wider mb-4">
              Resources
            </div>
            {[
              "Features",
              ...
              <Link
                key={item}
                className="block px-2 py-1.5 text-small text-default-400 hover:text-foreground rounded-medium hover:bg-default-100"
                href="/"
              >
                {item}
              </Link>
