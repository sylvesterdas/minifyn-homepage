      ...
      <div className="space-y-6">
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="grid grid-cols-3 gap-4 pt-2">
              {[
                ...
                <div key={item.label} className="p-3 rounded-lg bg-slate-800/30 border border-slate-700/50">
        ...
        <div className="grid grid-cols-3 gap-6 mt-8">
          {[
            ...
            <div key={item.title} className="p-4 rounded-lg bg-slate-900/30 border border-slate-800/50">
