    ...
    <div className="p-6 min-h-screen text-white">
      ...
      <section className="p-6 rounded-lg shadow-md">
        ...
        <ul className="list-disc list-inside mb-4">
          <li className="mb-2">Personal Information: name, email address, IP address</li>
          <li className="mb-2">Usage Data: how you interact with our service</li>
          <li className="mb-2">Device Information: browser type, operating system</li>
          <li className="mb-2">Cookies and Similar Technologies: we use these to enhance your experience and collect usage data</li>
        </ul>
        ...
        <ul className="list-disc list-inside mb-4">
          ...
          <li className="mb-2">Personalize and improve the service and provide advertisements, content, or features that match user profiles or interests</li>
        </ul>
        ...
        <ul className="list-disc list-inside mb-4">
          <li className="mb-2">Consent: You have given us permission to process your personal data for specific purposes</li>
          <li className="mb-2">Performance of a Contract: Processing is necessary for a contract we have with you</li>
          <li className="mb-2">Legal Obligations: Processing is necessary for us to comply with the law</li>
          <li className="mb-2">Legitimate Interests: Processing is necessary for our legitimate interests or those of a third party</li>
        </ul>
        ...
        <h2 className="text-2xl font-semibold mb-4">7. Your Data Protection Rights Under GDPR</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-semibold mb-4">8. Your Rights Under CCPA</h2>
        <p className="mb-4">
          If you are a California resident, you have the right to:
        </p>
        <ul className="list-disc list-inside mb-4">
          <li className="mb-2">Request disclosure of the personal information we collect, use, disclose, and sell about you</li>
          <li className="mb-2">Request the deletion of your personal information</li>
          <li className="mb-2">Opt-out of the sale of your personal information</li>
        </ul>
        <h2 className="text-2xl font-semibold mb-4">9. Use of Cookies and Tracking Technologies</h2>
        <p className="mb-4">
        ...
        <p className="mb-4">
          Email: <a className="text-blue-400" href="mailto:privacy@minifyn.com">privacy@minifyn.com</a><br />
          Postal Address: MiniFyn, Thiruvananthapuram, Kerala, India - 695524
        </p>
      </section>
    </div>
  );
