...
export async function createShortUrl(
  ...
  if (isUrlBlocked(longUrl)) {
    const ex = new Error('This URL cannot be shortened due to security or policy concerns. Please check our Acceptable-Use policy')
    ex.code = 400
    throw ex
  }
